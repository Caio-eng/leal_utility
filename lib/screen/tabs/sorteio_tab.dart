...
class SorteioTab extends StatefulWidget {
  const SorteioTab({super.key});

  @override
  _SorteioTabState createState() => _SorteioTabState();
}

class _SorteioTabState extends State<SorteioTab> {
